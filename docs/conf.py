# -*- coding: utf-8 -*-
#
# pyramid_swagger documentation build configuration file, created by
...
project = u'pyramid_swagger'
copyright = u'2014, Scott Triglia'
...
htmlhelp_basename = 'pyramid_swaggerdoc'
